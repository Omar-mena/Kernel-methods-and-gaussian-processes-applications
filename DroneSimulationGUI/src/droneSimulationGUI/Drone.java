...
public class Drone {
	public int x, y;
	private int droneId, dx, dy; // x and y will be the positions of the drone and the dx and dy are the
									// difference in the new positions
	...
	/**
	 * bx: is the horizontal position for the drone by: is the vertical position for
	 * the drone bz: the direction from the direction class
	 */
	...
	/**
	 * sx: to see if x has this position already sy: to see if y has this position
	 * already
	 */
	...
	/**
	 * nx: setting the x ny: setting the y
	 */
	...
	/**
	 * This method to be used in DroneArena class in Show drones method using
	 * ConsoleCanvas object c
	 */
	public void displayDrone(MyCanvas c) {
		c.showCircle(x, y, 3, 'D'); // using the showIt method in console Canvas class to show the place of the
									// drone within the arena as D

	}

	/**
	 * a method to move drones in the same direction that they assigned too and to
	 * check if the the moving possible, using a DroneArena Object area
	 */
