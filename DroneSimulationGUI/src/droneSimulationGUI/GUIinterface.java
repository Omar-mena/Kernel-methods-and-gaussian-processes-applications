...
import droneSimulationGUI.MyCanvas;
import droneSimulationGUI.DroneArena;
...
public class GUIinterface extends Application {
	...
	private DroneArena ourArena; // object for solar system
	...
	public void drawStatus() {
		...
		// now create label
		Label l = new Label(ourArena.toString());
	...
	private void showAbout() {
		showMessage("About", "Mohammad's Drone GUI ");
	...
	private HBox setButtons() {
		...
		return new HBox(btnAnimOn, btnAnimOff, btnAddDrone);
	}
	...
	public void start(Stage stagePrimary) throws Exception {
		stagePrimary.setTitle("27021107 basic GUI for Drones as balls");
		...
		ourArena = new DroneArena(400, 400); // create object for sun, planets, etc
		...
		new AnimationTimer() // create timer
		{
			public void handle(long currentNanoTime) {
				...
				if (animationOn) {
					...
					ourArena.moveAllDrones(); // calculate coordinates of planets etc
